...
PROXIES_BANNED_THRESHOLD = int(os.environ.get("PROXIES_BANNED_THRESHOLD")) \
    if os.environ.get("PROXIES_BANNED_THRESHOLD") else 20

ERROR_TOLERANCE_AVAILABILITY_CRAWLER = int(os.environ.get("ERROR_TOLERANCE_AVAILABILITY_CRAWLER")) \
     if os.environ.get("ERROR_TOLERANCE_AVAILABILITY_CRAWLER") else 20
ERROR_TOLERANCE_DETAILS_CRAWLER = int(os.environ.get("ERROR_TOLERANCE_DETAILS_CRAWLER")) \
     if os.environ.get("ERROR_TOLERANCE_DETAILS_CRAWLER") else 20
ERROR_TOLERANCE_SCROLL_CRAWLER = int(os.environ.get("ERROR_TOLERANCE_SCROLL_CRAWLER")) \
     if os.environ.get("ERROR_TOLERANCE_SCROLL_CRAWLER") else 20
